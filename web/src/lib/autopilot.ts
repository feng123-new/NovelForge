...
export interface AutopilotPage { jobs: AutopilotJob[]; worker_available: boolean; model_available: boolean; limit: number; offset: number }
...
export interface AutopilotDetail { job: AutopilotJob; foundation: unknown; chapter_plan: unknown; candidate_text: string; quality: unknown }
